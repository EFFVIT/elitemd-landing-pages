...
//
// Elite MD note: the hair pages render (925) 886-3926 = DEFAULT_DIGITS below.
// The aesthetics pages render (925) 291-4445 — a second static number this
// swap does NOT touch (single-pool design). If aesthetics call tracking is
// wanted later, add a second pool + a variant mount, don't overload this one.
// This component is inert until the elitemd `dni_pools` row exists in control
// with real numbers; until then no lease returns and the static number stays.

const DNI_ENDPOINT = 'https://control.effvit.com/api/dni/lease'
const CLIENT = 'elitemd'
const DEFAULT_DIGITS = '9258863926'
