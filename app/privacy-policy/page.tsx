...
export const metadata: Metadata = {
  title: 'Privacy Policy | Elite MD Plastic Surgery Danville',
  ...
  return (
    <div style={{ fontFamily: "'Jost', 'Poppins', sans-serif", color: '#1a1a1a', background: WHITE }}>
      ...
      <div style={{ background: DARK, padding: '48px 48px', textAlign: 'center' }}>
        <h1 style={{ fontFamily: 'copperplate, "Copperplate Gothic Light", "Copperplate Gothic", serif', fontWeight: 700, color: WHITE, fontSize: 40, margin: 0, lineHeight: 1.2 }}>Privacy Policy</h1>
      ...
      <main style={{ maxWidth: 860, margin: '0 auto', padding: '64px 48px' }}>
        <p style={{ fontSize: 16, lineHeight: 1.8, color: '#444', marginBottom: 24 }}>
          Thank you for choosing to be part of our community at Elite MD (&quot;company&quot;, &quot;we&quot;, &quot;us&quot;, or &quot;our&quot;). We are committed to protecting your personal information and your right to privacy. If you have any questions or concerns about our policy, or our practices with regards to your personal information, please contact us at <a href="mailto:info@elitemdspa.com" style={{ color: GOLD }}>info@elitemdspa.com</a>.
        </p>
        <p style={{ fontSize: 16, lineHeight: 1.8, color: '#444', marginBottom: 24 }}>
          When you visit our website https://start.elitemdspa.com and use our services, you trust us with your personal information. We take your privacy very seriously. In this privacy notice, we describe our privacy policy. We seek to explain to you in the clearest way possible what information we collect, how we use it and what rights you have in relation to it. If there are any terms in this privacy policy that you do not agree with, please discontinue use of our websites and our services.
        </p>
        <p style={{ fontSize: 16, lineHeight: 1.8, color: '#444', marginBottom: 48 }}>
          This privacy policy applies to all information collected through our website (such as https://start.elitemdspa.com) and/or any related services, sales, marketing or events.
        </p>

        <hr style={{ border: 'none', borderTop: '1px solid #e8e8e8', marginBottom: 48 }} />

        <h2 style={{ fontSize: 18, fontWeight: 700, color: DARK, marginBottom: 16 }}>Table of Contents</h2>
        <ol style={{ color: GOLD, fontSize: 15, lineHeight: 2.2, paddingLeft: 24, marginBottom: 48 }}>
          {[
          ...
          ].map((item) => <li key={item} style={{ color: '#333' }}>{item}</li>)}
        </ol>

        <hr style={{ border: 'none', borderTop: '1px solid #e8e8e8', marginBottom: 48 }} />

        <Section title="1. What Information Do We Collect?" gold={GOLD}>
        ...
        <Section title="2. How Do We Use Your Information?" gold={GOLD}>
        ...
        <Section title="3. Will Your Information Be Shared With Anyone?" gold={GOLD}>
        ...
        <Section title="4. Do We Use Cookies and Other Tracking Technologies?" gold={GOLD}>
          <p><em>In Short: We may use cookies and other tracking technologies to collect and store your information.</em></p>
          <p>We may use cookies and similar tracking technologies (like web beacons and pixels) to access or store information. Specific information about how we use such technologies and how you can refuse certain cookies is set out in our <a href="/cookie-policy" style={{ color: GOLD }}>Cookie Policy</a>.</p>
        </Section>

        <Section title="5. How Long Do We Keep Your Information?" gold={GOLD}>
        ...
        <Section title="6. How Do We Keep Your Information Safe?" gold={GOLD}>
        ...
        <Section title="10. Do We Make Updates to This Policy?" gold={GOLD}>
        ...
        <Section title="11. How Can You Contact Us About This Policy?" gold={GOLD}>
          <p>If you have questions or comments about this policy, you may email us at <a href="mailto:info@elitemdspa.com" style={{ color: GOLD }}>info@elitemdspa.com</a> or by post to:</p>
        ...
        <div style={{ background: '#faf5ee', borderLeft: `4px solid ${GOLD}`, padding: '24px 28px', borderRadius: 4 }}>
          <h3 style={{ fontSize: 16, fontWeight: 700, color: DARK, margin: '0 0 8px' }}>Personal Data Management</h3>
          <p style={{ fontSize: 15, color: '#444', lineHeight: 1.7, margin: 0 }}>
            According to the Privacy Policy, you agree to share your personal data with our service. However, you still have the right to update, transfer or delete it from us at any time. If you need further management for your data, please contact us at <a href="mailto:info@elitemdspa.com" style={{ color: GOLD }}>info@elitemdspa.com</a>.
          </p>
        </div>
      </main>
