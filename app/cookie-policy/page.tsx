  ...
  return (
    <div style={{ fontFamily: "'Jost', 'Poppins', sans-serif", color: '#1a1a1a', background: WHITE }}>
      ...
      <main style={{ maxWidth: 860, margin: '0 auto', padding: '64px 48px' }}>
        ...
        <Section title="First and Third Party Cookies" gold={GOLD}>
          <p>Whether a cookie is &apos;first party&apos; or &apos;third party&apos; refers to the website or domain placing the cookie. First-party cookies are set by Elite MD directly when you visit our site. Third-party cookies are placed by other companies whose features or services appear on our site. Elite MD does not have access to or control over these third-party cookies.</p>
        </Section>

        <Section title="How We Use Cookies" gold={GOLD}>
        ...
        <Section title="Analytics Cookies" gold={GOLD}>
        ...
        <Section title="Advertising Cookies" gold={GOLD}>
          <p><strong>Google</strong> - Elite MD works with Google to display targeted advertising across the web. These ads may appear on websites unrelated to us and are based on your interests and online behavior. These cookies allow Google to track your browsing patterns across websites. This information is used to help display ads that are more relevant to you.</p>
        </Section>

        <Section title="Flash Cookies" gold={GOLD}>
        ...
        <Section title="Web Beacons" gold={GOLD}>
        ...
        <Section title="Targeted Advertising" gold={GOLD}>
        ...
        <Section title="How to Control Cookies" gold={GOLD}>
        ...
        <Section title="How Often Will We Update This Cookie Policy" gold={GOLD}>
        ...
        <Section title="Contact Us" gold={GOLD}>
