/* ============================================================================
   CONSULT FUNNEL — CLIENT CONFIG: Elite MD
   ...
   elitemdspa.com sits behind a WAF that answers 403 to non-browser clients and 500 on /terms-of-service/. Both terms_url and posts_api are therefore null: that is UNKNOWN, not proven-absent (H-39). Re-check in a real browser before treating either as missing. Accent gold darkened to #8A6F34 for text contrast on cream.
   ========================================================================== */
...
export const CONSULT = {
  ...
  /* GoHighLevel sub-account. The container must carry GHL_PIT_PiHFEVdB3JB2GzFImTNA
     or every booking call 500s while the page still renders. */
  locationId: 'PiHFEVdB3JB2GzFImTNA',
  ...
  calendars: {
    'in-person': '17wRB79RHACFIWYXnjeP',
    virtual: 'k2ZtmR58c8qXKgn18d5Y',
  },
  ...
  address: '4185 Blackhawk Plaza Cir',
  city: 'Danville, CA 94506',
  officeShort: 'Danville',
  inPersonWhere: 'At the Danville office, 4185 Blackhawk Plaza Cir.',
  ...
  phoneDisplay: '(925) 886-3926',
  phoneRaw: '+19258863926',
  phonePlaceholder: '(925) 555-0142',

  siteUrl: 'https://elitemdspa.com',
  ...
  subhead: '60 minutes with Elite MD, in person in Danville or by video. Choose a time below and it is confirmed on the practice calendar straight away.',
  metaDescription: 'Book a 60 minutes consultation with Elite MD. In person in Danville or by video.',
...
/* Attribution write-through to the CRM.
   ...
   GET /locations/PiHFEVdB3JB2GzFImTNA/customFields, retried with backoff, from both
